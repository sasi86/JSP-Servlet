...
import com.sasi.agiledeveloper.model.Customer;

/*
 * Not thread-safe. For illustration purpose only
 */
@WebServlet(name = "CustomerServlet", description="Example for Hidden Field use URL - http://localhost:8080/SampleWar/customer"
...
public class CustomerServlet extends HttpServlet {
    ...
    private void sendCustomerList(HttpServletResponse response)
        ...
        Cookie c = new Cookie("key1","value1");
